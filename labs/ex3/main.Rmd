...
When you run `bc <- readRDS("data/bc")` you will get a `Seurat` object 
that has already been normalized and subjected to dimensionality reduction by PCA.
...
We find quite a few significant terms related to epithelial development and cell development which
makes somewhat sense since we are looking at epithelial derived cancer cells.

*Q12:* Now run another fea but this time on T-cell markers and set the avg_logFC to 0.5 when 
