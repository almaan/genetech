...
Here you can already see some ptentially interesting structures in the data; some bigger blobs, 
...
We already know that the cancer microenvironment contain a diverse set of cell types so now the next 
...
the _memory B-cell_ would belong to the supergroup of _immune cells_ 
...
# Select top markers
library(dplyr)
top2.markers <- group_by(bc.markers, cluster)
...
FeaturePlot(bc, features = "S.Score")
```
