...
author: "Original : Joseph Bergenstråhle - Edit : Ludvig Larsson, Alma Andersson, Sailendra Pradhananga "
date: "04 Oct 2020"
output:
...
```{r marker_per_celltype, fig.width=10, fig.height=12}
# Write your code/answer here
```
...
```{r phase_score, fig.width=10, fig.height=12}
# Write your code/answer here
```
