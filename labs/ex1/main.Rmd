...
Stack overflow and Google are your friends, but they will not always be there for
...
Say What? This makes no sense at all, how can we even compare a character with a number? Shouldn't this, if something, raise an error?
