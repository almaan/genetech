...
There are also ways of linking logical expressions, creating a compound
...
If we use a list insted, the output will be different:
...
that constitute its elements (second dimension). When the lists or vectors that
