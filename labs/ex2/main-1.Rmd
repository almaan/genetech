...
>
> 1.  What data types you have here?
>
> 2.  What dimensions the data has?
>
...
> Add a new column to the `gg` data.frame with log10-transformed gene expression values for COL1A1 and use it to draw a new histogram with these values.
...
> Exclude all genes in `counts` that have a total count across all samples less then of equal to 100. Use the skills you learned in Lab 1.
>
