...
Exploratory data analysis (EDA) can sometimes be useful to better nderstand the data
...
Perhaps a more interesting test would be to make pairwise comparisons between each
subtypes against all other subtypes to obtain DEGs that are specific to each subtype.
