...
When you have raw sequencing reads, filter them based on quality and map them back to the reference genome or you use de novo assembly tool to construct the genome. 
In the next step you filter the mapping results and remove PCR duplicates. 
Normalisation is needed for the reads because there is differences in the amount of reads, samples, mapping bias etc. 
Differential gene expression analysis, clustering and network analysis follow normalisation. 
