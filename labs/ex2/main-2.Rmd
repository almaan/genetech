...
In this part of the lab we will give you the output of the R code directly. Instead the focus is to understand what type of data one could get out of variant analysis and genome-wide association studies (GWAS). The data is available here: https://github.com/monogenea/GWAStutorial. If you want to run the code, just copy the whole repo to the "../genetech/labs/ex2/data"
